...
import { getChatMessages, sendAdminMessage } from "@/lib/chat-actions";
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 -8px 60px rgba(251,113,133,0.2)",
        }}
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: "linear-gradient(135deg, #1a0a0f, #2d0718)",
            borderRadius: "28px 28px 0 0",
          }}
        >
          <div
          ...
          <div className="flex-1">
            <p className="font-semibold text-rose-100 text-sm" style={{ fontFamily: "var(--font-jost)" }}>
              Chat with Hala 💌
            </p>
            <p className="text-xs text-rose-400" style={{ fontFamily: "var(--font-jost)", fontWeight: 300 }}>
              She sees you as her knight in shining armor 🛡️
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-3">
          {messages.length === 0 && (
            <div className="flex-1 flex flex-col items-center justify-center text-center py-10">
              ...
              <p className="text-rose-400 text-lg" style={{ fontFamily: "var(--font-cormorant)" }}>
                Send her a message, my lord
              </p>
              ...
              <div className="flex flex-col gap-0.5 max-w-[75%]">
                <div
                  ...
                  style={{
                    ...
                    background:
                      msg.sender === "admin"
                        ? "linear-gradient(135deg, #1a0a0f, #be123c)"
                        : "rgba(253,164,175,0.15)",
                    color: msg.sender === "admin" ? "white" : "#9f1239",
                    borderBottomRightRadius: msg.sender === "admin" ? "6px" : "18px",
                    borderBottomLeftRadius: msg.sender === "hala" ? "6px" : "18px",
                  }}
                >
                  {msg.content}
                </div>
                <p
                  className={`text-[10px] text-gray-400 ${msg.sender === "admin" ? "text-right" : "text-left"} px-1`}
                  style={{ fontFamily: "var(--font-jost)" }}
                >
                  {msg.sender === "admin" ? "You (Knight 🛡️)" : "Hala 💕"} ·{" "}
            ...
            style={{
              background:
                input.trim() && !sending
                  ? "linear-gradient(135deg, #1a0a0f, #be123c)"
                  : "rgba(0,0,0,0.07)",
              boxShadow: input.trim() ? "0 3px 12px rgba(190,18,60,0.25)" : "none",
            }}
          >
